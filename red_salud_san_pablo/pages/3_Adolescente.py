...
st.set_page_config(
    layout="wide",
    page_title="Red San Pablo - Adolescente",
    page_icon="🏥",
...
<div class="topbar-sp">
    <div class="topbar-sp-left">
        ...
        <div>
            ...
            <div class="topbar-sp-sub">Curso de Vida &nbsp;·&nbsp; Adolescente</div>
        </div>
    </div>
...
with st.sidebar:
    ...
    st.markdown(
        ...
        'RED SAN PABLO · ADULTO<br>© César Malca - 2026</p>',
        unsafe_allow_html=True
    )
...
<div class="hero-header">
    ...
    <h1 class="hero-title">SEGUIMIENTO DE PAQUETE SEGUIMIENTO DE PAQUETE <span>ADOLESCENTE</span></h1>
 ...
 # ── DESCARGA ──────────────────────────────────────────────────────────────
    ...
    with col_dl:
        ...
        with pd.ExcelWriter(buffer, engine="openpyxl") as writer:
            df_final.to_excel(writer, index=True, sheet_name="Adolescente")
        excel_bytes = buffer.getvalue()
        st.download_button(
            label="📥 Descargar Reporte Excel",
            data=excel_bytes,
            file_name="adolescente_san_pablo_2026.xlsx",
