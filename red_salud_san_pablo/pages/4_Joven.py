...
st.set_page_config(
    layout="wide",
    page_title="Red San Pablo - Joven",
    page_icon="LOGO.png",
...
ITEMS_CONFIG = [
    ("99801",     "99801_TA",    "99801\nPLAN ELABORADO"),           # Valor_Lab == "TA"
    ("Z019",      "Z019",        "Z019\nVALORACION RIESGO"),
    ("99401.13",  "99401.13",    "99401.13\nESTILOS VIDA"),
    ("99199.22",  "99199.22",    "99199.22\nPRESION ARTERIAL"),
    ("99209.04",  "99209.04",    "99209.04\nEVAL. ANTROPOMETRICA"),
    ("99403.01",  "99403.01",    "99403.01\nCONS. NUTRICIONAL"),
    ...
    # Columna combinada: 86703.01 O 86318.01 (nunca los dos juntos)
    ("__VIH_PR__","__VIH_PR__",  "86703/86318\nDETECCION VIH"),
    ("99401.34",  "99401.34",    "99401.34\nPOST-TEST VIH"),
    ("99402.08",  "99402.08_1",  "99402.08\nCONS. CANCER (1)"),     # Valor_Lab == "1"
    ("99402.08",  "99402.08_2",  "99402.08\nCONS. CANCER (2)"),     # Valor_Lab == "2"
    ("A150",      "A150",        "A150\nTUBERCULOSIS"),
    ("99199.58",  "99199.58",    "99199.58\nMUESTRA TBC"),
    ("99401",     "99401",       "99401\nCONS. INTEGRAL"),
    ("99801",     "99801_1",     "99801\nPLAN EJECUTADO"),            # Valor_Lab == "1"
]
...
<div class="hero-header">
    ...
    <h1 class="hero-title">SEGUIMIENTO DE PAQUETE SEGUIMIENTO DE PAQUETE <span>JOVEN</span></h1>
   ...
   # ── DESCARGA ──────────────────────────────────────────────────────────────
    ...
    with col_dl:
        ...
        with pd.ExcelWriter(buffer, engine="openpyxl") as writer:
            df_final.to_excel(writer, index=True, sheet_name="Joven")
        excel_bytes = buffer.getvalue()
        st.download_button(
            label="📥 Descargar Reporte Excel",
            data=excel_bytes,
            file_name="joven_san_pablo_2026.xlsx",
