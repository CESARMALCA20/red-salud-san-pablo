...
st.set_page_config(
    layout="wide",
    page_title="Red San Pablo - Adulto",
    page_icon="LOGO.png",
...
<div class="hero-header">
    ...
    <h1 class="hero-title">SEGUIMIENTO DE PAQUETE SEGUIMIENTO DE PAQUETE <span>ADULTO</span></h1>
 ...
 # ── DESCARGA ──────────────────────────────────────────────────────────────
    ...
    with col_dl:
        ...
        with pd.ExcelWriter(buffer, engine="openpyxl") as writer:
            df_final.to_excel(writer, index=True, sheet_name="Adulto")
        excel_bytes = buffer.getvalue()
        st.download_button(
            label="📥 Descargar Reporte Excel",
            data=excel_bytes,
            file_name="adulto_san_pablo_2026.xlsx",
