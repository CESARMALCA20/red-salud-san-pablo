...
adulto_mayor_bp = Blueprint("adulto_mayor", __name__)
...
ITEMS_CONFIG = [
    ...
    ("99215.03", "99215.03",  "99215.03 ADULTO MAYOR FRAGIL"),
    ("99401",    "99401_PAM", "99401 PAM INDEPENDIENTE"),
    ("Z6361",    "Z6361",     "Z6361 PAM INDEPENDIENTE"),
    ("Z6362",    "Z6362",     "Z6362 DEPEN. PARCIAL"),
    ("Z6363",    "Z6363",     "Z6363 DEPEN. TOTAL"),
    ("96150.01", "96150.01",  "96150.01 TAMIZAJE VIF"),
    ("96150.02", "96150.02",  "96150.02 ALCOHOL Y DROGAS"),
    ("96150.03", "96150.03",  "96150.03 DEPRESIÓN PHQ-9"),
    ("96150.07", "96150.07",  "96150.07 DETERIORO COGNIT."),
    ("99402.09", "99402.09",  "99402.09 CONS. S. MENTAL"),
    ("99173",    "99173",     "99173 AGUDEZA VISUAL"),
    ("99401.16", "99401.16",  "99401.16 CONS. S. OCULAR"),
    ("Z019",     "Z019",      "Z019 VALORACIÓN RIESGO"),
    ...
    ("90670",    "90670",     "90670 VAC. NEUMOCOCO"),
    ("90749.01", "90749.01",  "90749.01 VAC. COVID"),
    ("C0011",    "C0011",     "C0011 VISITA FAMILIAR"),
    ("88141",    "88141",     "88141 CANCER UTERO"),
    ...
    ("99386.03", "99386.03",  "99386.03 EXAMEN MAMA"),
]
N_ITEMS = len(ITEMS_CONFIG)

SOLO_MUJER  = {"88141", "88141.01", "99386.03"}
SOLO_HOMBRE = {"84152"}
...
<title>Red San Pablo — Adulto Mayor</title>
...
<div class="topbar">
  <div class="topbar-left">
    ...
    <div>
      ...
      <div class="topbar-sub">Curso de Vida · Adulto Mayor</div>
    </div>
  </div>
...
<div class="content">
  <!-- HERO -->
  <div class="hero">
    <h1>SEGUIMIENTO DE PAQUETE <span>ADULTO MAYOR</span></h1>
    <p>Población objetivo: 60 años a más · {N_ITEMS} indicadores evaluados</p>
  </div>

  <!-- FILTERS -->
  <form method="GET" action="/adulto-mayor">
    <div class="filters">
      ...
      <div class="filter-actions">
        ...
        <a href="/adulto-mayor" class="btn-clear">
...
function descargarExcel() {{
    ...
    XLSX.utils.book_append_sheet(wb, ws, 'Adulto Mayor');
...
@adulto_mayor_bp.route("/adulto-mayor")
def adulto_mayor():
    # Si no hay ningún parámetro en la URL, redirigir con la IPRESS por defecto
    if not request.args:
        from flask import redirect, url_for
        return redirect(url_for("adulto_mayor.adulto_mayor", ipress=IPRESS_DEFAULT))
