...
<title>Red San Pablo — Adolescente</title>
...
<div class="topbar">
  <div class="topbar-left">
    ...
    <div>
      ...
      <div class="topbar-sub">Curso de Vida · Adolescente</div>
    </div>
  </div>
...
<div class="content">
  <!-- HERO -->
  <div class="hero">
    <h1>SEGUIMIENTO DE PAQUETE <span>ADOLESCENTE</span></h1>
    <p>Población objetivo: 12 – 17 años · {N_ITEMS} indicadores evaluados</p>
  </div>

  <!-- FILTERS -->
  <form method="GET" action="/adolescente">
    <div class="filters">
      ...
      <div class="filter-actions">
        ...
        <a href="/adolescente" class="btn-clear">
...
function descargarExcel() {{
    ...
    XLSX.utils.book_append_sheet(wb, ws, 'Adolescente');
...
@adolescente_bp.route("/adolescente")
def adolescente():
    # Adolescente 12-17 años
    # Si no hay ningún parámetro en la URL, redirigir con la IPRESS por defecto
    if not request.args:
        from flask import redirect, url_for
        return redirect(url_for("adolescente.adolescente", ipress=IPRESS_DEFAULT))
