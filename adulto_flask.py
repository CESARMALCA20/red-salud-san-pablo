...
adulto_bp = Blueprint("adulto", __name__)
...
<title>Red San Pablo — Adulto</title>
...
<div class="topbar">
  <div class="topbar-left">
    ...
    <div>
      ...
      <div class="topbar-sub">Curso de Vida · Adulto</div>
    </div>
  </div>
...
<div class="content">
  <!-- HERO -->
  <div class="hero">
    <h1>SEGUIMIENTO DE PAQUETE <span>ADULTO</span></h1>
    <p>Población objetivo: 30 – 59 años · {N_ITEMS} indicadores evaluados</p>
  </div>

  <!-- FILTERS -->
  <form method="GET" action="/adulto">
    <div class="filters">
...
function descargarExcel() {{
    ...
    XLSX.utils.book_append_sheet(wb, ws, 'Adulto');
...
@adulto_bp.route("/adulto")
def adulto():
    # Adulto 30-59 años
    # Si no hay ningún parámetro en la URL, redirigir con la IPRESS por defecto
    if not request.args:
        from flask import redirect, url_for
        return redirect(url_for("adulto.adulto", ipress=IPRESS_DEFAULT))
