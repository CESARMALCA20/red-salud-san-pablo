...
nino_bp = Blueprint("nino", __name__)
...
def _get_df():
    ...
    try:
        ...
        df = df.filter((pl.col('Anio_Actual_Paciente') >= 0) & (pl.col('Anio_Actual_Paciente') <= 11))
...
<title>Red San Pablo — Niño</title>
...
<div class="topbar">
  <div class="topbar-left">
    ...
    <div>
      ...
      <div class="topbar-sub">Curso de Vida · Niño</div>
    </div>
  </div>
...
<div class="content">
  <!-- HERO -->
  <div class="hero">
    <h1>SEGUIMIENTO DE PAQUETE <span>NIÑO</span></h1>
    <p>Población objetivo: 0 – 11 años · {N_ITEMS} indicadores evaluados</p>
  </div>

  <!-- FILTERS -->
  <form method="GET" action="/nino">
    <div class="filters">
...
function descargarExcel() {{
    ...
    XLSX.utils.book_append_sheet(wb, ws, 'Nino');
...
def nino():
    ...
    if not request.args:
        ...
        return redirect(url_for("nino.nino", ipress=IPRESS_DEFAULT))
